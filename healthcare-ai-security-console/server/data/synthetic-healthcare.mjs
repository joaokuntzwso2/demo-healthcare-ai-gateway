...
export const workforce = {
  ...
  'bh-001': { id:'bh-001',tenant:'helios-north',display:'Dr. Hannah Lee',role:'attending-psychiatrist',specialty:'Behavioral Health',scopes:[...physicianScopes,'restricted:behavioral-health:read'] },
...
export const careAssignments = {
  ...
  'pulm-001': ['pat-1002'],
  'pharm-001': ['pat-1005','pat-1001'],
  'nurse-001': ['pat-1001','pat-1003'],
  'care-001': ['pat-1007','pat-1001'],
